...
[assembly: WebActivator.PreApplicationStartMethod(typeof(ICurrentChainRecipe.Web.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace ICurrentChainRecipe.Web.App_Start
{
