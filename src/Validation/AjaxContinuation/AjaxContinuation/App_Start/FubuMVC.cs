...
[assembly: WebActivator.PreApplicationStartMethod(typeof(AjaxContinuation.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace AjaxContinuation.App_Start
{
    using StructureMap;
