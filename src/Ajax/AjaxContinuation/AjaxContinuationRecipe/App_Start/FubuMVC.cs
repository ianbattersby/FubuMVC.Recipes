...
[assembly: WebActivator.PreApplicationStartMethod(typeof(AjaxContinuationRecipe.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace AjaxContinuationRecipe.App_Start
{
    using StructureMap;
    ...
    public static class AppStartFubuMVC
    {
        public static void Start()
        {
            ...
            FubuApplication.For<ConfigureFubuMVC>() // ConfigureFubuMVC is the main FubuRegistry
                ...
                .StructureMapObjectFactory(configure => configure.AddRegistry<AjaxValidationRegistry>())
                .Bootstrap();
    ...
    public class AjaxValidationRegistry : Registry
    {
        public AjaxValidationRegistry()
        {
            Scan(x =>
            {
