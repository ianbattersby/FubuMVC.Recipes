...
[assembly: WebActivator.PreApplicationStartMethod(typeof(DownloadStream.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace DownloadStream.App_Start
{
